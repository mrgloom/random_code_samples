...
import config
from unet_weighted_bce_loss import weighted_binary_cross_entropy_loss
from unet_weighted_bce_loss import all_zeros_baseline, pred_min, pred_max, y_true_sum, y_pred_sum
...
EXPERIMENT_NAME = 'unet_coord_conv'
...
def get_model():
    ...
    base = get_unet(inputs, config.N_CLASSES, is_use_coord_conv=True)
